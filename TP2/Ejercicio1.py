...
def calcularDemoraP1(tiemposMuestras, mu1, mu2, p, n):
    ...
    tiemposProveedorM1 = calcularDemora(tiemposMuestrasM1, tiemposEsperaM1, len(tiemposMuestrasM1))

    tiemposEsperaM2 = np.random.exponential(mu2, len(tiemposMuestrasM2))
    tiemposProveedorM2 = calcularDemora(tiemposMuestrasM1, tiemposEsperaM2, len(tiemposMuestrasM2))
